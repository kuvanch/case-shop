                        ...
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    ...
                                    pretty heavy stretchmarks on all of my last
                                    phone cases. This one, besides a barely
                                    noticeable scratch on the corner{" "}
                                    <span className="p-0.5 bg-slate-800 text-white">
                                        looks branch new after about half a year
                                    </span>
                                    . I dig it.
                                </p>
                            </div>
                    ...
                    <div className="max-auto max-w-6xl px-6 lg:px-8">
                        <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                            <img
                                ...
                                alt=""
                            />
                            <div className="relative h-80 nd:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                                <img
                                    src="/horse.jpg"
